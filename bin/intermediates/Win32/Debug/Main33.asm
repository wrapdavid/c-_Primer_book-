; Listing generated by Microsoft (R) Optimizing Compiler Version 19.23.28106.4 
	...
	TITLE	C:\Users\R2\Desktop\yoda\learning_myself\c_c++\Visual_c++\c++_Primer_book\src\Main33.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_09GDLDMGHB@high?5pass@			; `string'
PUBLIC	??_C@_08CLMGNHGH@mid?5pass@			; `string'
PUBLIC	??_C@_04BBDAIEHH@pass@				; `string'
PUBLIC	??_C@_07NADCHLA@no?5pass@			; `string'
...
CONST	ENDS
;	COMDAT ??_C@_07NADCHLA@no?5pass@
CONST	SEGMENT
??_C@_07NADCHLA@no?5pass@ DB 'no pass', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_04BBDAIEHH@pass@
CONST	SEGMENT
??_C@_04BBDAIEHH@pass@ DB 'pass', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_08CLMGNHGH@mid?5pass@
CONST	SEGMENT
??_C@_08CLMGNHGH@mid?5pass@ DB 'mid pass', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_09GDLDMGHB@high?5pass@
CONST	SEGMENT
??_C@_09GDLDMGHB@high?5pass@ DB 'high pass', 00H	; `string'
CONST	ENDS
...
_pl$ = -132						; size = 28
_s$ = -96						; size = 28
_finalgrade$ = -60					; size = 28
_grade$ = -24						; size = 4
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
_main	PROC						; COMDAT
; File C:\Users\R2\Desktop\yoda\learning_myself\c_c++\Visual_c++\c++_Primer_book\src\Main33.cpp
; Line 4
	push	ebp
	mov	ebp, esp
	push	-1
	...
	lea	eax, DWORD PTR __$EHRec$[ebp]
	mov	DWORD PTR fs:0, eax
	mov	ecx, OFFSET __7908241C_Main33@cpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 5
	mov	DWORD PTR _grade$[ebp], 95		; 0000005fH
; Line 6
	cmp	DWORD PTR _grade$[ebp], 90		; 0000005aH
	jle	SHORT $LN7@main
	mov	DWORD PTR tv71[ebp], OFFSET ??_C@_09GDLDMGHB@high?5pass@
	jmp	SHORT $LN8@main
$LN7@main:
	cmp	DWORD PTR _grade$[ebp], 75		; 0000004bH
	jle	SHORT $LN5@main
	mov	DWORD PTR tv70[ebp], OFFSET ??_C@_08CLMGNHGH@mid?5pass@
	jmp	SHORT $LN6@main
$LN5@main:
	cmp	DWORD PTR _grade$[ebp], 60		; 0000003cH
	jle	SHORT $LN3@main
	mov	DWORD PTR tv69[ebp], OFFSET ??_C@_04BBDAIEHH@pass@
	jmp	SHORT $LN4@main
$LN3@main:
	mov	DWORD PTR tv69[ebp], OFFSET ??_C@_07NADCHLA@no?5pass@
$LN4@main:
...
$LN8@main:
	...
	push	edx
	lea	ecx, DWORD PTR _finalgrade$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@QBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 0
; Line 7
	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	lea	eax, DWORD PTR _finalgrade$[ebp]
	push	eax
	...
	call	__RTC_CheckEsp
; Line 11
	push	OFFSET ??_C@_04EHIOMBPF@word@
...
; Line 12
	...
	jne	SHORT $LN9@main
	mov	DWORD PTR tv92[ebp], OFFSET ??_C@_00CNPNBAHC@@
	jmp	SHORT $LN10@main
$LN9@main:
	mov	DWORD PTR tv92[ebp], OFFSET ??_C@_01LKDEMHDF@s@
$LN10@main:
