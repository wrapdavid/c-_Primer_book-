; Listing generated by Microsoft (R) Optimizing Compiler Version 19.23.28106.4 
	...
	TITLE	C:\Users\R2\Desktop\yoda\learning_myself\c_c++\Visual_c++\c++_Primer_book\src\Main32.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$LN11@Compat:
	...
	push	OFFSET ??_C@_1LO@MGELDLOO@?$AAs?$AAt?$AAd?$AA?3?$AA?3?$AA_?$AAV?$AAe?$AAc?$AAt?$AAo?$AAr?$AA_?$AAc?$AAo@
...
$LN19@operator:
	...
	push	65					; 00000041H
	push	OFFSET ??_C@_1MO@NOOOHLI@?$AAC?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe@
	push	OFFSET ??_C@_1MG@OPNGNDCB@?$AAs?$AAt?$AAd?$AA?3?$AA?3?$AA_?$AAV?$AAe?$AAc?$AAt?$AAo?$AAr?$AA_?$AAc?$AAo@
...
$T4 = -349						; size = 1
_i$5 = -148						; size = 4
_<end>$L0$6 = -136					; size = 4
_<begin>$L0$7 = -124					; size = 4
_<range>$L0$8 = -112					; size = 4
_begin$9 = -100						; size = 12
_odd$ = -80						; size = 16
_end$ = -56						; size = 12
_value$ = -36						; size = 16
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
_main	PROC						; COMDAT
; File C:\Users\R2\Desktop\yoda\learning_myself\c_c++\Visual_c++\c++_Primer_book\src\Main32.cpp
; Line 4
	push	ebp
	mov	ebp, esp
	push	-1
	...
	lea	eax, DWORD PTR __$EHRec$[ebp]
	mov	DWORD PTR fs:0, eax
	mov	ecx, OFFSET __44680DAC_Main32@cpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 5
	push	16					; 00000010H
	...
	mov	DWORD PTR $T2[ebp+4], 3
	mov	DWORD PTR $T2[ebp+8], 6
	mov	DWORD PTR $T2[ebp+12], 5
	mov	DWORD PTR $T2[ebp+16], 4
	mov	DWORD PTR $T2[ebp+20], 8
	mov	DWORD PTR $T2[ebp+24], 9
	mov	DWORD PTR $T2[ebp+28], 11		; 0000000bH
	lea	ecx, DWORD PTR $T4[ebp]
	call	??0?$allocator@H@std@@QAE@XZ		; std::allocator<int>::allocator<int>
	push	eax
	lea	eax, DWORD PTR $T2[ebp+32]
	push	eax
	lea	ecx, DWORD PTR $T2[ebp]
	push	ecx
...
; Line 9
	push	12					; 0000000cH
	lea	ecx, DWORD PTR _begin$9[ebp]
	call	?__autoclassinit2@?$_Vector_iterator@V?$_Vector_val@U?$_Simple_types@H@std@@@std@@@std@@QAEXI@Z
	lea	eax, DWORD PTR _begin$9[ebp]
	push	eax
	lea	ecx, DWORD PTR _value$[ebp]
...
; Line 1240
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax]
	cmp	ecx, DWORD PTR __Parent_proxy$4[ebp]
	je	SHORT $LN4@Adopt
; Line 1241
	mov	esi, esp
	push	3
...
; Line 1244
	mov	eax, DWORD PTR __Parent_proxy$4[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+4], ecx
; Line 1245
	mov	eax, DWORD PTR _this$[ebp]
