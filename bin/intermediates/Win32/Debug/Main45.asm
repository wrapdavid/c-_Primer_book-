; Listing generated by Microsoft (R) Optimizing Compiler Version 19.23.28106.4 
	...
	TITLE	C:\Users\R2\Desktop\yoda\learning_myself\c_c++\Visual_c++\c++_Primer_book\src\Main45.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?interactvie_f@@YAXXZ				; interactvie_f
...
PUBLIC	??_C@_0CB@KOHIDIHJ@Enter?5a?5number?5within?5?$FL1?0?513?$FN?5?3@ ; `string'
PUBLIC	??_C@_0CB@EKCDBAAJ@Out?5of?5range?0?5please?5try?5again?4@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_0CB@EKCDBAAJ@Out?5of?5range?0?5please?5try?5again?4@
CONST	SEGMENT
??_C@_0CB@EKCDBAAJ@Out?5of?5range?0?5please?5try?5again?4@ DB 'Out of ran'
	DB	'ge, please try again.', 0aH, 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0CB@KOHIDIHJ@Enter?5a?5number?5within?5?$FL1?0?513?$FN?5?3@
CONST	SEGMENT
??_C@_0CB@KOHIDIHJ@Enter?5a?5number?5within?5?$FL1?0?513?$FN?5?3@ DB 'Ent'
	DB	'er a number within [1, 13] :', 0aH, 00H	; `string'
CONST	ENDS
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$?interactvie_f@@YAXXZ DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?interactvie_f@@YAXXZ$0
	DD	00H
	DD	FLAT:__unwindfunclet$?interactvie_f@@YAXXZ$1
__ehfuncinfo$?interactvie_f@@YAXXZ DD 019930522H
	DD	02H
	DD	FLAT:__unwindtable$?interactvie_f@@YAXXZ
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
_TEXT	SEGMENT
_main	PROC						; COMDAT
; File C:\Users\R2\Desktop\yoda\learning_myself\c_c++\Visual_c++\c++_Primer_book\src\Main45.cpp
; Line 23
	push	ebp
	mov	ebp, esp
	sub	esp, 192				; 000000c0H
	...
	mov	eax, -858993460				; ccccccccH
	rep stosd
	mov	ecx, OFFSET __EB4DE104_Main45@cpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 26
	call	?interactvie_f@@YAXXZ			; interactvie_f
; Line 27
	xor	eax, eax
; Line 29
	pop	edi
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?interactvie_f@@YAXXZ
_TEXT	SEGMENT
$T2 = -300						; size = 4
_i$3 = -96						; size = 4
_out_of_range$ = -84					; size = 28
_prompt$ = -48						; size = 28
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
?interactvie_f@@YAXXZ PROC				; interactvie_f, COMDAT
; File C:\Users\R2\Desktop\yoda\learning_myself\c_c++\Visual_c++\c++_Primer_book\src\Main45.cpp
; Line 8
	push	ebp
	mov	ebp, esp
	push	-1
	push	__ehhandler$?interactvie_f@@YAXXZ
	mov	eax, DWORD PTR fs:0
	push	eax
	...
	call	@__CheckForDebuggerJustMyCode@4
; Line 9
	push	OFFSET ??_C@_0CB@KOHIDIHJ@Enter?5a?5number?5within?5?$FL1?0?513?$FN?5?3@
	lea	ecx, DWORD PTR _prompt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@QBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 0
; Line 10
	push	OFFSET ??_C@_0CB@EKCDBAAJ@Out?5of?5range?0?5please?5try?5again?4@
	lea	ecx, DWORD PTR _out_of_range$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@QBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
...
; Line 12
	...
	movzx	eax, al
	test	eax, eax
	je	SHORT $LN3@interactvi
; Line 14
	cmp	DWORD PTR _i$3[ebp], 1
	jl	SHORT $LN6@interactvi
	cmp	DWORD PTR _i$3[ebp], 13			; 0000000dH
	jle	SHORT $LN5@interactvi
$LN6@interactvi:
; Line 16
	lea	eax, DWORD PTR _out_of_range$[ebp]
	push	eax
	mov	ecx, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	ecx
	call	??$?6DU?$char_traits@D@std@@V?$allocator@D@1@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@ABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@@Z ; std::operator<<<char,std::char_traits<char>,std::allocator<char> >
...
; Line 21
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN15@interactvi
	call	@_RTC_CheckStackVars@8
	pop	eax
	pop	edx
	mov	ecx, DWORD PTR __$EHRec$[ebp]
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?interactvie_f@@YAXXZ$0:
	lea	ecx, DWORD PTR _prompt$[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
__unwindfunclet$?interactvie_f@@YAXXZ$1:
	lea	ecx, DWORD PTR _out_of_range$[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
__ehhandler$?interactvie_f@@YAXXZ:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	...
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?interactvie_f@@YAXXZ
	jmp	___CxxFrameHandler3
text$x	ENDS
?interactvie_f@@YAXXZ ENDP				; interactvie_f
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?fun@@YAHH@Z
_TEXT	SEGMENT
tv69 = -196						; size = 4
_i$ = 8							; size = 4
?fun@@YAHH@Z PROC					; fun, COMDAT
; File C:\Users\R2\Desktop\yoda\learning_myself\c_c++\Visual_c++\c++_Primer_book\src\Main45.cpp
; Line 4
	push	ebp
	mov	ebp, esp
