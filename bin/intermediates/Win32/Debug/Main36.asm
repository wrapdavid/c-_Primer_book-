; Listing generated by Microsoft (R) Optimizing Compiler Version 19.23.28106.4 
	...
	TITLE	C:\Users\R2\Desktop\yoda\learning_myself\c_c++\Visual_c++\c++_Primer_book\src\Main36.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_03LPHLELND@A?$CL?$CL@			; `string'
...
CONST	ENDS
;	COMDAT ??_C@_03LPHLELND@A?$CL?$CL@
CONST	SEGMENT
??_C@_03LPHLELND@A?$CL?$CL@ DB 'A++', 00H		; `string'
CONST	ENDS
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__ehfuncinfo$??A?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@1@I@Z DD 019930522H
	DD	00H
	DD	00H
	DD	2 DUP(00H)
	DD	2 DUP(00H)
...
; Line 1461
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$??A?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@1@I@Z
	mov	eax, DWORD PTR fs:0
	push	eax
	sub	esp, 216				; 000000d8H
	push	ebx
...
;	COMDAT text$x
text$x	SEGMENT
__ehhandler$??A?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@1@I@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-232]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$??A?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@QBEABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@1@I@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
...
$T6 = -304						; size = 8
$T7 = -285						; size = 1
_lettergrade$8 = -84					; size = 28
_grade$ = -48						; size = 4
_scores$ = -36						; size = 16
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
_main	PROC						; COMDAT
; File C:\Users\R2\Desktop\yoda\learning_myself\c_c++\Visual_c++\c++_Primer_book\src\Main36.cpp
; Line 3
	push	ebp
	mov	ebp, esp
	push	-1
	...
	lea	eax, DWORD PTR __$EHRec$[ebp]
	mov	DWORD PTR fs:0, eax
	mov	ecx, OFFSET __B1E8AB6C_Main36@cpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 4
	push	16					; 00000010H
	...
	push	OFFSET ??_C@_01HMGJMAIH@B@
	lea	ecx, DWORD PTR $T2[ebp+84]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@QBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	BYTE PTR __$EHRec$[ebp+8], 3
	push	OFFSET ??_C@_01FHEEJDEE@A@
	lea	ecx, DWORD PTR $T2[ebp+112]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@QBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	BYTE PTR __$EHRec$[ebp+8], 4
	push	OFFSET ??_C@_03LPHLELND@A?$CL?$CL@
...
; Line 5
	mov	DWORD PTR _grade$[ebp], 50		; 00000032H
$LN2@main:
; Line 6
	mov	esi, esp
	...
	test	eax, eax
	je	$LN3@main
	cmp	DWORD PTR _grade$[ebp], 100		; 00000064H
	jg	$LN3@main
; Line 8
	cmp	DWORD PTR _grade$[ebp], 60		; 0000003cH
	jge	SHORT $LN5@main
	push	0
	lea	ecx, DWORD PTR _scores$[ebp]
...
$LN6@main:
	...
	push	eax
	lea	ecx, DWORD PTR _lettergrade$8[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ABV01@@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
...
; Line 9
	...
	cmp	edx, 7
	jle	SHORT $LN10@main
	mov	DWORD PTR tv178[ebp], OFFSET ??_C@_01MIFGBAGJ@?$CL@
	jmp	SHORT $LN11@main
$LN10@main:
	mov	eax, DWORD PTR _grade$[ebp]
	cdq
	...
	cmp	edx, 3
	jge	SHORT $LN8@main
	mov	DWORD PTR tv177[ebp], OFFSET ??_C@_01JOAMLHOP@?9@
	jmp	SHORT $LN9@main
$LN8@main:
	mov	DWORD PTR tv177[ebp], OFFSET ??_C@_01CLKCMJKC@?5@
$LN9@main:
...
$LN11@main:
	...
	jmp	SHORT $LN12@main
$LN7@main:
	mov	DWORD PTR tv179[ebp], OFFSET ??_C@_00CNPNBAHC@@
$LN12@main:
...
; Line 10
	...
	lea	eax, DWORD PTR _lettergrade$8[ebp]
	push	eax
