...
; Line 3
	...
	lea	eax, DWORD PTR __$EHRec$[ebp]
	mov	DWORD PTR fs:0, eax
	mov	ecx, OFFSET __F648D1BC_Main35@cpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 4
	push	16					; 00000010H
...
; Line 6
	lea	ecx, DWORD PTR _lettergrade$[ebp]
...
; Line 7
	...
	test	eax, eax
	je	$LN3@main
	cmp	DWORD PTR _grade$[ebp], 101		; 00000065H
	je	$LN3@main
; Line 9
...
; Line 18
	...
	cmp	edx, 7
	jle	SHORT $LN11@main
	mov	DWORD PTR tv179[ebp], OFFSET ??_C@_01MIFGBAGJ@?$CL@
	jmp	SHORT $LN12@main
$LN11@main:
	mov	eax, DWORD PTR _grade$[ebp]
	cdq
	...
	cmp	edx, 3
	jge	SHORT $LN9@main
	mov	DWORD PTR tv178[ebp], OFFSET ??_C@_01JOAMLHOP@?9@
	jmp	SHORT $LN10@main
$LN9@main:
	mov	DWORD PTR tv178[ebp], OFFSET ??_C@_00CNPNBAHC@@
$LN10@main:
...
; Line 21
	...
	lea	eax, DWORD PTR _lettergrade$[ebp]
	push	eax
