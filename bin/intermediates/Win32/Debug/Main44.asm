; Listing generated by Microsoft (R) Optimizing Compiler Version 19.23.28106.4 
	...
	TITLE	C:\Users\R2\Desktop\yoda\learning_myself\c_c++\Visual_c++\c++_Primer_book\src\Main44.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_0O@ONIFKPAL@divisor?5is?50?5@		; `string'
PUBLIC	??_C@_0BP@FHNEJNLB@?6?5try?5again?5?$DP?5enter?5yes?5or?5no?5@ ; `string'
...
??_R4exception@std@@6B@ DD 00H				; std::exception::`RTTI Complete Object Locator'
	...
	DD	FLAT:??_R3exception@std@@8
rdata$r	ENDS
;	COMDAT ??_C@_0BP@FHNEJNLB@?6?5try?5again?5?$DP?5enter?5yes?5or?5no?5@
CONST	SEGMENT
??_C@_0BP@FHNEJNLB@?6?5try?5again?5?$DP?5enter?5yes?5or?5no?5@ DB 0aH, ' '
	DB	'try again ? enter yes or no ', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0O@ONIFKPAL@divisor?5is?50?5@
CONST	SEGMENT
??_C@_0O@ONIFKPAL@divisor?5is?50?5@ DB 'divisor is 0 ', 00H ; `string'
CONST	ENDS
...
__$EHRec$ = -16						; size = 16
_main	PROC						; COMDAT
; File C:\Users\R2\Desktop\yoda\learning_myself\c_c++\Visual_c++\c++_Primer_book\src\Main44.cpp
; Line 3
	push	ebp
	mov	ebp, esp
	push	-1
	...
	mov	DWORD PTR fs:0, eax
	mov	DWORD PTR __$EHRec$[ebp], esp
	mov	ecx, OFFSET __D62DC8B4_Main44@cpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 4
...
; Line 11
	...
	jne	SHORT $LN5@main
; Line 13
	push	OFFSET ??_C@_0O@ONIFKPAL@divisor?5is?50?5@
...
; Line 20
	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0BP@FHNEJNLB@?6?5try?5again?5?$DP?5enter?5yes?5or?5no?5@
	lea	ecx, DWORD PTR _err$6[ebp]
	call	?what@exception@std@@UBEPBDXZ		; std::exception::what
	push	eax
...
; Line 130
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __DA238ACC_stdexcept
	call	@__CheckForDebuggerJustMyCode@4
